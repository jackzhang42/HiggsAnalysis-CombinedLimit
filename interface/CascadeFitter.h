#ifndef HiggsAnalysis_CombinedLimit_CascadeFitter_h
#define HiggsAnalysis_CombinedLimit_CascadeFitter_h
...
class CascadeFitter {
    public:
        ...
        CascadeFitter(RooAbsReal &nll, Mode mode, RooRealVar *poi=0) ;
...
class CascadeFitterGlobalConfigs{

	private:
	  CascadeFitterGlobalConfigs(){};
	  CascadeFitterGlobalConfigs(const CascadeFitterGlobalConfigs&) {};
	  CascadeFitterGlobalConfigs& operator=(const CascadeFitterGlobalConfigs&);
	...
	public:
	  ...
	  static CascadeFitterGlobalConfigs& O(){

		static CascadeFitterGlobalConfigs singleton;
		return singleton;
	  }
